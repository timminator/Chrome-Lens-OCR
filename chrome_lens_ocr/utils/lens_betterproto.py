...
class LensOverlayPhaseLatenciesMetadataPhase(betterproto.Message):
    ...
    image_downscale_data: "LensOverlayPhaseLatenciesMetadataPhaseImageDownscaleData" = betterproto.message_field(3, group="phase_data")
    """Data specifically only relevant for IMAGE_DOWNSCALE_END PhaseType."""

    image_encode_data: "LensOverlayPhaseLatenciesMetadataPhaseImageEncodeData" = betterproto.message_field(4, group="phase_data")
...
class LensOverlayInteractionRequestMetadataSelectionMetadata(betterproto.Message):
    ...
    point: "LensOverlayInteractionRequestMetadataSelectionMetadataPoint" = betterproto.message_field(1, group="selection")
    region: "LensOverlayInteractionRequestMetadataSelectionMetadataRegion" = betterproto.message_field(2, group="selection")
    object: "LensOverlayInteractionRequestMetadataSelectionMetadataObject" = betterproto.message_field(3, group="selection")
